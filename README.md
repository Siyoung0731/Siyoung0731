...
<img src="jinguMarket.jpg" width="100%" alt="JinguMarket"/>
...
**Digital Convergence - Java & Spring Developer Course**

📅 **2025.02 – 2026.07**

- Java & Spring Boot 기반 웹 애플리케이션 개발
- JSP / Servlet 기반 CRUD 구현 및 REST API 개발
- MySQL 데이터베이스 설계 및 SQL 활용
- HTML / CSS / JavaScript 기반 UI 구현
- SW 개발 보안, 애플리케이션 테스트 및 팀 프로젝트 수행
...
- GPA **4.1 / 4.5**
- Database, Java Programming, Web Application Development
- Capstone Design (Smart Farm Monitoring System)
